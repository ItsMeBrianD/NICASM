...
public enum Command {
    ...
    LD   ("LD",   "(LD)([\\s]+)"  +REGISTER+SPACE+"("+VARIABLE+"|"+IMM8+")",                 "0010", "DR XXXXXXXXX   "),
    ...
    LEA  ("LEA",  "(LEA)([\\s]+)" +REGISTER+SPACE+"("+VARIABLE+"|"+IMM16+")",                "1110", "DR XXXXXXXXX   "),
    NOT  ("NOT",  "(NOT)([\\s]+)" +REGISTER+SPACE+REGISTER,                                  "1001", "DR SR 111111   "),
    RET  ("RET",  "(RET)([\\s]*)",                                                           "1100", "000111000000   "),
    ST   ("ST",   "(ST)([\\s]+)"  +REGISTER+SPACE+"("+VARIABLE+"|"+IMM8+")",                 "0011", "SR XXXXXXXXX   "),
