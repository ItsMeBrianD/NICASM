...
public enum Command {
    ...
    LDR ("LDR",  "(LDR)([\\s]+)" +REGISTER+SPACE+REGISTER+SPACE+"("+VARIABLE+"|"+IMM6+")",  "0110", "DR BR XXXXXX   "),
    ...
    STR ("STR",  "(STR)([\\s]+)" +REGISTER+SPACE+REGISTER+SPACE+"("+VARIABLE+"|"+IMM6+")",  "0111", "SR BR XXXXXX   "),
